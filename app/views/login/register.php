...
<div id="header">
  ...
  <div id="header-left">
    ...
    <div class="panel panel-default">
          <div class="panel-heading"><button type="button" class="btn btn-link">Add User</button></div>
          <div class="panel-body">
	<form onsubmit="registerUser" id="formregister" method="POST" enctype="multipart/form-data">
  	 <fieldset class="form-group">
       <p>File:<input type="file" name="image"></p>
    </fieldset>
    <fieldset class="form-group">
       <label for="nameForm">Name</label>
       <input type="text" class="form-control" id="nameForm" name="nameForm"  placeholder="Name Surname">
    </fieldset>
     <fieldset class="form-group">
       <label for="ninForm">National Identification Number</label>
       <input type="text" class="form-control" id="ninForm" name="ninForm"  placeholder="National Identification Number">
    </fieldset>
      <fieldset class="form-group">
      <label for="nationalityForm">Nationality</label>
      <select class="form-control" id="nationalityForm" name="nationalityForm" >
...
<input onclick="register();" type="submit" name="submit" class="btn btn-primary" value="Submit">

  ...
  <div id="header-left">
    ...
    <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form action="modifyProductQuantity" id="formregister" method="POST" enctype="multipart/form-data">
    <fieldset class="form-group">
      <label for="nsnFormQuantity">NSN</label>
      <input type="text" class="form-control" id="nsnFormQuantity" name="nsnFormQuantity" placeholder="NSN">
    </fieldset>
    <fieldset class="form-group">
      <label for="quantityFormQuantity">Quantity</label>
      <input type="number" class="form-control" id="quantityFormQuantity"  name="quantityFormQuantity" placeholder="Quantity">
    </fieldset>
